...
import { findAutomation } from '@/actions/automations/query';
import {
  createChatHistory,
  getChatHistory,
  ...
  try {
    ...
    if (matcher && matcher.automationId) {
      ...
      if (webhook_payload.entry[0].messaging) {
        ...
        console.log('the smart ai autimation', automation);
        ...
        if (automation && automation.trigger) {
          ...
          if (
            ...
            console.log('start smar ai message ');
            try {
              ...
              console.log('smart_ai_message', smart_ai_message);
      ...
      if (
        ...
        console.log('the automation', automation);
